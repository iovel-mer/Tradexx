...
export const Market: React.FC = () => {
  ...
  return (
    <section className="py-12  mx-auto sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-slate-50 via-white to-gray-100 min-h-screen relative overflow-hidden">
      {/* Subtle Grid Pattern */}
