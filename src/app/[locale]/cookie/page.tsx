...
export default function CookiePage() {
  ...
  return (
    <>
      <Header />
      <main className="min-h-screen py-4 pt-6 sm:pt-8 md:pt-10  mx-auto px-4 relative bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
